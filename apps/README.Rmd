...
<p align='center'>
```{r, out.width="50%"}
knitr::include_graphics(here::here("misc", "lorenz_app_sample.png"))
```
</p>
...
<p align='center'>
```{r, out.width="50%"}
knitr::include_graphics(here::here("misc", "top_centile_prescribing_sample.png"))
```
</p>
...
<p align='center'>
```{r, out.width="50%"}
knitr::include_graphics(here::here("misc", "top_centile_app_sample.png"))
```
</p>
...
<p align='center'>
```{r, out.width="50%"}
knitr::include_graphics(here::here("misc", "ineq_app_sample.png"))
```
</p>
...
<p align='center'>
```{r, out.width="50%"}
knitr::include_graphics(here::here("misc", "rel_prescribing_app_sample.png"))
```
</p>
