...
results in text files. We are working with the data providers to find an
acceptable way to provide restricted access to these data to other allow
researchers access to these data.
